...
// Mutator for data class `CodeGeneratedForDataClasses`.`Person` (io.peekandpoke.mutator.examples.code_generation.CodeGeneratedForDataClasses.Person)
 ...
 */
@MutatorDsl
inline fun <reified X : `CodeGeneratedForDataClasses`.`Person`> ListMutator<`CodeGeneratedForDataClasses`.`Person`>.filterMutatorsOf(): List<Mutator<X>> {
 ...
 */
@MutatorDsl
inline fun <reified X : `CodeGeneratedForDataClasses`.`Person`> SetMutator<`CodeGeneratedForDataClasses`.`Person`>.filterMutatorsOf(): List<Mutator<X>> {
    return mapNotNull { mutator ->
        if (mutator.get() is X) {
            @Suppress("UNCHECKED_CAST")
            mutator as Mutator<X>
...
@MutatorDsl
inline fun <K> Map<K, `CodeGeneratedForDataClasses`.`Person`>.mutator() = mutator(child = { mutator() })

@MutatorDsl
inline fun <K> Map<K, `CodeGeneratedForDataClasses`.`Person`>.mutate(
    mutation: MapMutator<K, `CodeGeneratedForDataClasses`.`Person`>.() -> Unit,
): Map<K, `CodeGeneratedForDataClasses`.`Person`> = mutator().apply(mutation).get()
...
// Mutator for data class `CodeGeneratedForDataClasses`.`Address` (io.peekandpoke.mutator.examples.code_generation.CodeGeneratedForDataClasses.Address)
// Generated by the 'BuiltIn: Mutable Objects Plugin' plugin
// Mutator creators ////////////////////////////////////////////////////////////////////////////////////
 ...
 */
@MutatorDsl
inline fun <reified X : `CodeGeneratedForDataClasses`.`Address`> ListMutator<`CodeGeneratedForDataClasses`.`Address`>.filterMutatorsOf(): List<Mutator<X>> {
    return mapNotNull { mutator ->
        if (mutator.get() is X) {
            @Suppress("UNCHECKED_CAST")
            mutator as Mutator<X>
 ...
 */
@MutatorDsl
inline fun <reified X : `CodeGeneratedForDataClasses`.`Address`> SetMutator<`CodeGeneratedForDataClasses`.`Address`>.filterMutatorsOf(): List<Mutator<X>> {
    return mapNotNull { mutator ->
        if (mutator.get() is X) {
            @Suppress("UNCHECKED_CAST")
            mutator as Mutator<X>
...
@MutatorDsl
inline fun <K> Map<K, `CodeGeneratedForDataClasses`.`Address`>.mutator() = mutator(child = { mutator() })

@MutatorDsl
inline fun <K> Map<K, `CodeGeneratedForDataClasses`.`Address`>.mutate(
    mutation: MapMutator<K, `CodeGeneratedForDataClasses`.`Address`>.() -> Unit,
): Map<K, `CodeGeneratedForDataClasses`.`Address`> = mutator().apply(mutation).get()
...
// Mutator for data class `CodeGeneratedForDataClasses`.`AddressBook` (io.peekandpoke.mutator.examples.code_generation.CodeGeneratedForDataClasses.AddressBook)
// Generated by the 'BuiltIn: Mutable Objects Plugin' plugin
// Mutator creators ////////////////////////////////////////////////////////////////////////////////////
 ...
 */
@MutatorDsl
inline fun <reified X : `CodeGeneratedForDataClasses`.`AddressBook`> ListMutator<`CodeGeneratedForDataClasses`.`AddressBook`>.filterMutatorsOf(): List<Mutator<X>> {
    return mapNotNull { mutator ->
        if (mutator.get() is X) {
            @Suppress("UNCHECKED_CAST")
            mutator as Mutator<X>
 ...
 */
@MutatorDsl
inline fun <reified X : `CodeGeneratedForDataClasses`.`AddressBook`> SetMutator<`CodeGeneratedForDataClasses`.`AddressBook`>.filterMutatorsOf(): List<Mutator<X>> {
    return mapNotNull { mutator ->
        if (mutator.get() is X) {
            @Suppress("UNCHECKED_CAST")
            mutator as Mutator<X>
...
@MutatorDsl
inline fun <K> Map<K, `CodeGeneratedForDataClasses`.`AddressBook`>.mutator() = mutator(child = { mutator() })

@MutatorDsl
inline fun <K> Map<K, `CodeGeneratedForDataClasses`.`AddressBook`>.mutate(
    mutation: MapMutator<K, `CodeGeneratedForDataClasses`.`AddressBook`>.() -> Unit,
): Map<K, `CodeGeneratedForDataClasses`.`AddressBook`> = mutator().apply(mutation).get()

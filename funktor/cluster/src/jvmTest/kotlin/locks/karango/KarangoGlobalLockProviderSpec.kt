...
class KarangoGlobalLockProviderSpec : StringSpec() {
    ...
    private val repo: KarangoGlobalLocksRepo get() = kontainer.get(KarangoGlobalLocksRepo::class)

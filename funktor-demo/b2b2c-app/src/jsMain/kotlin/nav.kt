...
import io.peekandpoke.funktor.demo.b2b2capp.layout.LoggedInLayout
import io.peekandpoke.funktor.demo.b2b2capp.layout.LoggedOutLayout
import io.peekandpoke.funktor.demo.b2b2capp.pages.DashboardPage
import io.peekandpoke.funktor.demo.b2b2capp.pages.NotFoundPage
...
fun RootRouterBuilder.mountNav(authState: AuthState<B2b2cUserModel>) {
    // Auth routes — the app wraps the shared AuthLogin widget in its own dedicated LoggedOutLayout
    // (the full-control composable path, same as b2b-app).
    ...
    // Protected uris, only available for logged in b2b2c end-users

...
/**
 * A b2b2c (end-user) tenant user — a B2B customer's own end-user. Carries [memberships] so the
 * login flow can resolve the user's accessible organisations and drive the 0/1/n org-selection
 * (see [B2b2cRealm]).
 */
@Vault

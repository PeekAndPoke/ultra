...
class SemanticTag(
    private val __parent: FlowContent,
    private val __cssClasses: MutableList<String>,
) {
    fun _cssClasses(): String = __cssClasses.filter { it.isNotBlank() }.joinToString(" ")
    ...
    @SemanticUiCssMarker
    operator fun plus(cls: String): SemanticTag = apply { __cssClasses.add(cls) }

    @SemanticUiCssMarker
    operator fun plus(classes: Array<out String>): SemanticTag = apply { __cssClasses.addAll(classes) }

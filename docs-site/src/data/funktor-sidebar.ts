export const funktorSidebar = [
    {href: '/ultra/funktor/', label: 'Why Funktor', section: 'Overview'},
    {href: '/ultra/funktor/getting-started', label: 'Getting Started', section: 'Overview'},
    {href: '/ultra/funktor/core', label: 'Core', section: 'Modules'},
    {href: '/ultra/funktor/rest', label: 'REST', section: 'Modules'},
    ...
    {href: '/ultra/funktor/testing', label: 'Testing', section: 'Modules'},
];
